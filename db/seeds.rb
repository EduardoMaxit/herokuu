...
Hospedaje.find_or_create_by(titulo: "Cabaña los kaukenes", encabezado: "Cabaña para descansar y disfrutar del buen clima", descripcion: "Cabaña situada a 4kms  del centro, no hay señal de tv , de radio ni movil. Consta de 2 habitaciones, cocina-comedor y baño con jacuzzi", provincia: "Entre Rios" , ciudad: "Concordia",  capacidad: "2" , usuario_id: 2 , tipo_id: 2 )
...
Hospedaje.find_or_create_by(titulo: "Departemento para disfrutar con la familia", encabezado: "Departamento en pleno centro , en la propia calle corrientes. Con vista hacia los teatros ", descripcion: "Es un departamento al cual no le falta nada, muy comodo para una familia de 4/5 que tenga ganas de disfrutar de los espectaculos que brinda la ciudad de Buenaos Aires  ", provincia: "Buenos Aires" , ciudad: "Ciudad Autonoma de Bsas",  capacidad: "5" , usuario_id: 1 , tipo_id: 3)
...
Hospedaje.find_or_create_by(titulo: "Pieza para disfrutar de la ciudad mas autral del mundo", encabezado: "Pieza amplia con baño privado", descripcion: "Se compartira la casa con sus dueños, dicha casa se encuentra a 5 km del centro invernal Cerro Castor", provincia: "Tierra del Fuego" , ciudad: "Ushuaia",  capacidad: "2", usuario_id: 2 , tipo_id: 4 )
